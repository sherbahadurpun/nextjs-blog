export default function Newsletter() {
  return (
    <section className="bg-gray-50 mt-20">
      <div className="container mx-auto md:py-20 py-16 text-center">
        ...
        <button className="bg-orange-400 px-20 py-3 rounded-full text-gray-50 text-xl hover:bg-orange-300">
          Subscribe
        </button>
      </div>
    </section>
